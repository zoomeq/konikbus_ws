...
<body>
    ...
    <main>
        <div class="box" id="ofirmie">
            ...
            <div id="jakrezerwowac" class="insideboxof ofir">
                <h2>Jak rezerwować</h2>
                <p>Aliquam et velit aliquet, tincidunt mauris sit amet, fermentum neque. Aenean orci arcu, scelerisque eget tellus convallis, faucibus gravida turpis. Nam iaculis et mauris et rutrum. Aenean congue, turpis eget tincidunt dapibus, arcu leo sollicitudin sem, nec convallis mi justo id lectus. Curabitur luctus leo quis rhoncus posuere. Cras eleifend massa nulla, eu mollis metus vehicula id. Curabitur pellentesque urna et nunc congue luctus. Suspendisse potenti. Nam accumsan neque id nibh aliquam, id tempus sem dapibus. Maecenas imperdiet non quam ac porta. Curabitur augue lacus, dictum sit amet rhoncus pretium, volutpat ac lacus. Aenean id tristique ipsum. Curabitur eget aliquam metus. Aliquam ac ligula blandit, imperdiet lectus in, tristique urna.</p>
                <div class="dummy"></div>
            </div>
            <div class="dummy"></div>
        </div>
        <div class="box" id="uslugi">
            <h1>Nasze Usługi</h1>
            <div id="usluga1" class="insideboxof usluga">
                <h2>Międzynarodowy przewóz osób</h2>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In neque justo, dignissim in est id, pulvinar iaculis enim. Vivamus non mauris et justo interdum lacinia id nec eros. Aliquam ullamcorper maximus tellus interdum fermentum. Donec eu tristique enim, at auctor lectus. Nulla pellentesque leo in viverra viverra. Ut mauris purus, posuere sed eleifend quis, elementum sed leo. Nulla a consequat turpis. Mauris interdum scelerisque purus vitae maximus. Nulla massa metus, volutpat nec metus commodo, venenatis vestibulum purus. Sed et lobortis arcu. Maecenas in cursus magna. Integer id eleifend odio, quis mattis metus. Morbi id eleifend risus. Ut fermentum ligula neque, a auctor magna rhoncus sed. Aenean vestibulum lorem sit amet suscipit rutrum. Curabitur a hendrerit orci.
                <a href="./zarezerwuj/"><p id="zarezerwuj_button">Zarezerwuj przejazd</p></a>
            </div>
            <div id="usluga2" class="insideboxof usluga">
                <h2>Transport przesyłek</h2>
                Aliquam et velit aliquet, tincidunt mauris sit amet, fermentum neque. Aenean orci arcu, scelerisque eget tellus convallis, faucibus gravida turpis. Nam iaculis et mauris et rutrum. Aenean congue, turpis eget tincidunt dapibus, arcu leo sollicitudin sem, nec convallis mi justo id lectus. Curabitur luctus leo quis rhoncus posuere. Cras eleifend massa nulla, eu mollis metus vehicula id. Curabitur pellentesque urna et nunc congue luctus. Suspendisse potenti. Nam accumsan neque id nibh aliquam, id tempus sem dapibus. Maecenas imperdiet non quam ac porta. Curabitur augue lacus, dictum sit amet rhoncus pretium, volutpat ac lacus. Aenean id tristique ipsum. Curabitur eget aliquam metus. Aliquam ac ligula blandit, imperdiet lectus in, tristique urna. Curabitur non dapibus ipsum.
                <a href="./nadaj/"><p id="zarezerwuj_button">Nadaj paczkę</p></a>
            </div>
            <div id="usluga3" class="insideboxof usluga">
                <h2>Wynajem auta</h2>
                Aliquam et velit aliquet, tincidunt mauris sit amet, fermentum neque. Aenean orci arcu, scelerisque eget tellus convallis, faucibus gravida turpis. Nam iaculis et mauris et rutrum. Aenean congue, turpis eget tincidunt dapibus, arcu leo sollicitudin sem, nec convallis mi justo id lectus. Curabitur luctus leo quis rhoncus posuere. Cras eleifend massa nulla, eu mollis metus vehicula id. Curabitur pellentesque urna et nunc congue luctus. Suspendisse potenti. Nam accumsan neque id nibh aliquam, id tempus sem dapibus. Maecenas imperdiet non quam ac porta. Curabitur augue lacus, dictum sit amet rhoncus pretium, volutpat ac lacus. Aenean id tristique ipsum. Curabitur eget aliquam metus. Aliquam ac ligula blandit, imperdiet lectus in, tristique urna. Curabitur non dapibus ipsum.
                <a href=" "><p id="zarezerwuj_button">Wynajmij auto</p></a>
            </div>   
            <div id="usluga4" class="insideboxof usluga">
                <h2>Transport pojazdów</h2>
                Aliquam et velit aliquet, tincidunt mauris sit amet, fermentum neque. Aenean orci arcu, scelerisque eget tellus convallis, faucibus gravida turpis. Nam iaculis et mauris et rutrum. Aenean congue, turpis eget tincidunt dapibus, arcu leo sollicitudin sem, nec convallis mi justo id lectus. Curabitur luctus leo quis rhoncus posuere. Cras eleifend massa nulla, eu mollis metus vehicula id. Curabitur pellentesque urna et nunc congue luctus. Suspendisse potenti. Nam accumsan neque id nibh aliquam, id tempus sem dapibus. Maecenas imperdiet non quam ac porta. Curabitur augue lacus, dictum sit amet rhoncus pretium, volutpat ac lacus. Aenean id tristique ipsum. Curabitur eget aliquam metus. Aliquam ac ligula blandit, imperdiet lectus in, tristique urna. Curabitur non dapibus ipsum.
                <a href=" "><p id="zarezerwuj_button">Ratujcie mnie</p></a>
            </div>     
        </div>
        <div class="box" id="obszar">
            <h1>Obsługiwany Obszar</h1>
            <div class="country">
                <h2>Polska</h2>
                TU MAPA Z OBSZAREM
            </div>
        ...
        <div class="box" id="praca">
            <h1>Praca</h1>
            <a href="./praca/" ><p id="zarezerwuj_button">Pracuj z nami :)</p></a>
        </div>
    </main>
    <footer>
