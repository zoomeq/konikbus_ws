    ...
    <main>
        ...
        <div id="rezerw2">
            <span id="szczegoly" class="float">
                ...
                <div class="clear"></div>
                <span id="regbut1" class="float"><p><input type="checkbox" name="regbut1" id="regbut1_1" class="float" required disabled>Akceptuje <a id="regbut1a" href="../regulamin/" target="_blank">regulamin</a> usługi</p></span>
                <div class="clear"></div>
        ...
        <input type="hidden" name="catId" value=65538>
         <span id="regbut2" class="float"><p><input type="checkbox" name="regbut2" id="regbut2_1" required disabled>Akceptuje <a id="regbut2a" href="../regulamin/" target="_blank">regulamin</a> usługi</p></span>
         <div class="clear"></div>
